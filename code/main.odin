...
Notify_Icon_Guid: GUID = {
	0xb73af445,
	0x45f8,
	0x4e57,
	{0xa2, 0xdd, 0xdb, 0xd6, 0x8a, 0x67, 0x99, 0x66},
}
App_Title: [^]u16
App_Icon: w.HICON
...
wnd_proc :: proc "stdcall" (
	...
	case w.WM_CREATE:
		...
		if ok == w.FALSE {
            err := w.GetLastError()
            log.errorf("Shell_NotifyIconW error %d", err)
		}
	...
	case WM_MMKEYS3_NOTIFY_ICON:
        log.info("WM_MMKEYS3_NOTIFY_ICON")
